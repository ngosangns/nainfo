...
const (
	...
	ProfileService_UpdateOrCreateProfile_FullMethodName = "/profile.ProfileService/UpdateOrCreateProfile"
)
...
type ProfileServiceClient interface {
	...
	UpdateOrCreateProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *profileServiceClient) UpdateOrCreateProfile(ctx context.Context, in *UpdateProfileRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, ProfileService_UpdateOrCreateProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProfileServiceServer interface {
	...
	UpdateOrCreateProfile(context.Context, *UpdateProfileRequest) (*Empty, error)
...
func (UnimplementedProfileServiceServer) UpdateOrCreateProfile(context.Context, *UpdateProfileRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrCreateProfile not implemented")
}
...
func _ProfileService_UpdateOrCreateProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProfileServiceServer).UpdateOrCreateProfile(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_UpdateOrCreateProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).UpdateOrCreateProfile(ctx, req.(*UpdateProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProfileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateOrCreateProfile",
			Handler:    _ProfileService_UpdateOrCreateProfile_Handler,
		},
	},
